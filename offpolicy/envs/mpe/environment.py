...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
                 observation_callback=None, personalized_reward_callback=None,
                 info_callback=None,
        ...
        self.personalized_reward_callback = personalized_reward_callback
    ...
    def step(self, action_n):
        ...
        for i, agent in enumerate(self.agents):
            ...
            info = {
                'individual_reward': self._get_reward(agent), 
                'personalized_reward': self._get_personalized_reward(agent),  # MARK: 在这里定义的 personalized_reward
            }
            info_n.append(info)
    ...
    def _get_personalized_reward(self, agent):
        if self.personalized_reward_callback is None:
            return 0.0
        return self.personalized_reward_callback(agent, self.world)
